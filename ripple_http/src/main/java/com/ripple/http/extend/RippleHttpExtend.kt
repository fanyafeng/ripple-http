...
class RippleHttpLinkExtra(private val rippleHttpLinkKotlin: RippleHttpLinkKotlin) {
    ...
    fun withGet(lambda: RippleHttpLinkExtra.() -> Unit) = apply {
        this.apply(lambda)
    ...
    fun thenGet(lambda: RippleHttpLinkExtra.() -> Unit) = apply {
        this.apply(lambda)
    ...
    fun withPost(lambda: RippleHttpLinkExtra.() -> Unit) = apply {
        this.apply(lambda)
    ...
    fun thenPost(lambda: RippleHttpLinkExtra.() -> Unit) = apply {
        this.apply(lambda)
